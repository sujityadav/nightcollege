...
export async function DELETE(req, { params }) {
  ...
  id,
    ...
    return NextResponse.json({ success: true, message: 'News updated', data: updated }, { status: 200 });
  } catch (error) {
    return NextResponse.json({ success: false, message: 'Error updating News', error: error.message }, { status: 500 });
  }
}