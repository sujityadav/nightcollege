  ...
  const actionTemplate = (product) => {
    return (
      <div className="flex  justify-center items-center gap-4 ">
        ...
        <Link href={`/admin/administration/add-administration?id=${product?._id}`} className="leading-none" >
    ...
    <div className="grid grid-cols-1">
      ...
      <div className='p-[20px] xl:p-[25px] 3xl:p-[1.563vw] w-full'>
        <div className='flex justify-between mb-5'>
          <div>
            <h2 className='text-[#19212A] text-[14px] xl:text-[22px] 3xl:text-[1.146vw] font-[700] m-0'>Administration</h2>
          </div>
          <div>
        ...
        <div className='bg-white border card-shadow '>
          ...
          <div className='overflow-auto'>
            ...
            >
              ...
              <Column
                field="AdministrationData.data.title"
                header="Title"
                sortable
                body={(rowData) => (
                  <a
                    href={`/admin/sub-administration?administrationId=${rowData._id}`} // Your target link
              ...
              <Column field="AdministrationData.data.smallDescription" header="Description" />
