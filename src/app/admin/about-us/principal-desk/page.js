  ...
  return (
    ...
    <div className="flex w-full">
      ...
      <div className='p-[20px] xl:p-[25px] 3xl:p-[1.563vw] w-full'>
        <div className='mb-3'>
          <div>
            <h2 className='text-[#19212A] text-[14px] xl:text-[22px] 3xl:text-[1.146vw] font-[700] m-0'>Principal Desk</h2>
          </div>
          ...
          <div className=' px-[20px] xl:px-[250px] 3xl:px-[13.021vw]'>
            <div className='space-y-3'>
              <div className='flex flex-col gap-1'>
                              <label className='text-[#212325] text-[14px] xl:text-[14px] 3xl:text-[0.729vw] font-[500]'>Name</label>
                              <InputText type="text" placeholder="Enter your title" className='border rounded-md' />
                            </div>

                            <div className='flex flex-col gap-1'>
                              <label className='text-[#212325] text-[14px] xl:text-[14px] 3xl:text-[0.729vw] font-[500]'>Qualification</label>
                              <InputText type="text" placeholder="Enter your title" className='border rounded-md' />
                            </div>
            ...
            <div className='mt-[30px]'>
              <div className='flex justify-center gap-6'>
                ...
                <button type='submit' className='text-white border bg-[#23468a] border-[#23468a] px-[14px] xl:px-[18px] 3xl:px-[0.938vw] py-[10px] xl:py-[12px] 3xl:py-[0.625vw] leading-[100%]'>
                  Save
                </button>
