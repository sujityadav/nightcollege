  ...
  return (
    <header className="flex items-center justify-between bg-white shadow-sm h-[80px] px-5 sticky top-0 z-20 border-b border-[#E5E7EB]">
      ...
      <div className="flex gap-5 items-center">
        ...
        <div>
          <Link href='/admin/file-manager' className="cancelbtn px-[14px] xl:px-[18px] 3xl:px-[0.938vw] py-[8px] xl:py-[10px] 3xl:py-[0.521vw] leading-[100%]">
            File Manager
          </Link>
        </div>
        ...
        <div
          ...
          onClick={(e) => op.current && op.current.toggle(e)} // safer check
        >
